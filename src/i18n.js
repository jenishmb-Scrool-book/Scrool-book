...
const ru = {
  ...
  'intro.t4': 'Обои как на настоящем телефоне',
  'intro.b4': 'Выбери любые из двадцати — домашний экран перестанет выглядеть нарисованным. Свою картинку можно поставить потом, в настройках.',
  ...
  'set.notif_nowhere': 'В браузере напоминания нет: будильник ставит Android, а страница для этого не просыпается. На телефоне переключатель работает.',
  'set.notif_failed': 'Не удалось поставить напоминание. Попробуй ещё раз.',
  'set.notif_done': 'Включено. Первое напоминание придёт {day} около 12:00.',
  'set.notif_today': 'сегодня',
  'set.notif_tomorrow': 'завтра',
  'set.notif_test': 'Прислать пробное',
  'set.notif_test_sent': 'Пробное придёт через 5 секунд — можно свернуть приложение.',
  'notif.test_title': 'Напоминание работает',
  'notif.test_body': 'Такое же будет приходить раз в день, около 12:00.',
...
const en = {
  ...
  'intro.t4': 'A wallpaper like a real phone has',
  'intro.b4': 'Pick any of the twenty and the home screen stops looking drawn. A picture of your own can go there later, in Settings.',
  ...
  'set.notif_nowhere': 'There is no reminder in a browser: the alarm is set by Android, and a page does not wake up for it. On the phone the switch works.',
  'set.notif_failed': 'Could not set the reminder. Try again.',
  'set.notif_done': 'On. The first reminder comes {day} around 12:00.',
  'set.notif_today': 'today',
  'set.notif_tomorrow': 'tomorrow',
  'set.notif_test': 'Send a test one',
  'set.notif_test_sent': 'The test one arrives in 5 seconds — you can leave the app.',
  'notif.test_title': 'The reminder works',
  'notif.test_body': 'The same one will come once a day, around 12:00.',
  'set.about': 'About',
