...
//
// Двадцать снимков уже лежат в сборке (см. `wallpaper.js`). Ни загрузки, ни
// разрешения на галерею: выбор из готового делается одним нажатием, а своя
// картинка ждёт в настройках и требует системного выбора файла — на первом
// запуске это лишний шаг.
