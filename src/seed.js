...
Переписка — текст приходит сообщениями, ответ листает дальше. Обёрток тут три, они переключаются в настройках.

Клипы — на весь экран, свайпом вверх.

Истории — по касанию: правая половина вперёд, левая назад.

Лента — постами. Видео — списком роликов. Короткие посты — самыми мелкими кусками, по паре предложений.
